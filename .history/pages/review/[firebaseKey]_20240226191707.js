...
function ViewReview({ reviewObj, onDashboard, onUpdate }) {
  ...
  PATCH https://nestnuggets-3fb46-default-rtdb.firebaseio.com/review/undefined.json 400 (Bad Request)
  const {
  ...
  return (
    <Card style={{ width: '40rem', margin: '10px' }}>
      ...
      <Card.Body>
        ...
        {reviewObj && (
          <Link href={`/book/${firebaseKey}`} passHref>
