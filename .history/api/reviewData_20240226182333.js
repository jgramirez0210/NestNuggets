...
const getSingleReview = (firebaseKey) => new Promise((resolve, reject) => {
  fetch(`https://nestnuggets-3fb46-default-rtdb.firebaseio.comreview/${firebaseKey}.json`, {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
    },
...
export {
  getReview, createReview, updateReview, updateRating, getReviewByUser, deleteReview, getSingleReview,
};
