...
// GET ALL RATINGS
const getAllRatings = (reviewId) => new Promise((resolve, reject) => {
  fetch(`${endpoint}/wasThisReviewHelpful.json?reviewId=${reviewId}`, {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
    },
...
export {
  getReview, createReview, updateReview, getReviewByUser, deleteReview, getSingleReview, createWasThisHelpfulReviewRating, updateWasThisHelpfulReviewRating, getWasThisReviewHelpful, getAllRatings,
};
