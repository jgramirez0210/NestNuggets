...
const getWasThisReviewHelpful = (reviewId) => new Promise((resolve, reject) => {
  // Make sure `endpoint` is defined in your code and points to your Firebase project URL
  fetch(`${endpoint}/wasThisReviewHelpful/${reviewId}.json`, {
    ...
    .then((data) => {
      console.warn(data); // Log the data for debugging
      resolve(data); // Resolve the promise with the data
    })
    .catch((error) => {
      console.warn('Fetching error:', error); // Log any errors that occur
