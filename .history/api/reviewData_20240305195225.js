...
const getSingleReviewRatings = (firbaeseKey) => new Promise((resolve, reject) => {
  fetch(`${endpoint}/books.json?orderBy="authorKey"&equalTo="${firbaeseKey}"`, {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
    },
...
export {
  getReview, createReview, updateReview, createWasThisHelpfulReviewRating, getReviewByUser, deleteReview, getSingleReview, getWasThisHelpfulReviewById,
};
