...
const checkIfRatingExists = (reviewId, uid) => new Promise((resolve, reject) => fetch(`${endpoint}/wasThisReviewHelpful.json?orderBy="reviewId"&equalTo="${reviewId}"&print=pretty`, {
  method: 'GET',
  headers: {
    'Content-Type': 'application/json',
  },
