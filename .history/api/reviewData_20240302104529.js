...
const getReviewRating = (uid) => new Promise((resolve, reject) => {
  fetch(`${endpoint}/reviewRating.json?orderBy="uid"&equalTo="${uid}"`, {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
    },
...
export {
  getReview, createReview, updateReview, updateRating, getReviewByUser, deleteReview, getSingleReview, viewReviewDetails, getReviewRating,
};
