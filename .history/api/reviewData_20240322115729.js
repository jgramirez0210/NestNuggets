...
const updateWasThisHelpfulReviewRating = (reviewId, firebaseKey, newRating) => new Promise((resolve, reject) => {
  console.warn('Update firebaseKey', firebaseKey);
  fetch(`${endpoint}/wasThisReviewHelpful/${reviewId}/${firebaseKey}.json`, {
    method: 'PATCH',
    headers: {
      'Content-Type': 'application/json',
    },
