...
const createReviewRating = (payload) => new Promise((resolve, reject) => {
  fetch(`${endpoint}/reviewRating.json`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
const updateRating = (firebaseKey, overviewRating, safetyRating, managementRating) => fetch(`${endpoint}/reviewRating/${firebaseKey}.json`, {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json',
  },
...
const getReviewById = (reviewId) => {
  ...
  return new Promise((resolve, reject) => {
    fetch(`${endpoint}/ratingReviews/${reviewId}.json`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
      },
...
export {
  getReview, createReview, updateReview, updateRating, getReviewByUser, deleteReview, getSingleReview, viewReviewDetails, getReviewById,
};
