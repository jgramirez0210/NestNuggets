...
const getWasThisReviewHelpful = (reviewId) =>
  new Promise((resolve, reject) => {
    const queryParams = `?orderBy="reviewId"&equalTo="${reviewId}"`;
    fetch(`${endpoint}/wasThisReviewHelpful.json${queryParams}`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
      },
      ...
      .then((data) => {
        if (data !== null && typeof data === 'object') {
          const wasThisHelpfulReviewById = Object.values(data);
