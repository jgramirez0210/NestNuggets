...
// const updateRatingOLD = (firebaseKey, overviewRating, safetyRating, managementRating) => {
//   fetch(`${endpoint}/reviewRating/${firebaseKey}.json`, {
//     method: 'POST',
//     headers: {
//       'Content-Type': 'application/json',
//     },
...
// };
const updateRating = (firebaseKey, payload) => new Promise((resolve, reject) => {
  fetch(`${endpoint}/reviewRating/${firebaseKey}.json`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
