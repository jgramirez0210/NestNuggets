...
const updateWasThisHelpfulReviewRating = (payload) => new Promise((resolve, reject) => {
  if (typeof payload !== 'object' || !payload.hasOwnProperty('reviewId')) {
    throw new Error('Invalid payload: payload must be an object and contain a reviewId property');
  }
...
export {
  getReview, createReview, updateReview, getReviewByUser, deleteReview, getSingleReview, createWasThisHelpfulReviewRating, updateWasThisHelpfulReviewRating, getWasThisHelpfulReviewRating, getCurrentRating,
};
