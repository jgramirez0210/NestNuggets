...
import { createWasThisHelpfulReviewRating, updateWasThisHelpfulReviewRating, getSingleReview } from '../api/reviewData';
...
const WasThisReviewHelpful = ({ firebaseKey, reviews, initialKey }) => {
  ...
  const handleRating = async (rating) => {
    ...
    try {
      ...
      const existingRating = await getWasThisHelpfulReviewRatingByUserAndReview(user.uid, firebaseKey);
