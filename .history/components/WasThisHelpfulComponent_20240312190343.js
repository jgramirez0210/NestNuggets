...
import { createWasThisHelpfulReviewRating, updateWasThisHelpfulReviewRating, getWasThisReviewHelpful, getAllRatings } from '../api/reviewData';
...
const WasThisReviewHelpful = ({ firebaseKey: initialFirebaseKey, reviews = [] }) => {
  ...
  const handleRating = async (ratingValue) => {
    ...
    const ratingsObject = await getAllRatings(initialFirebaseKey);
    console.warn('Initial FirebaseKey', initialFirebaseKey);
    console.warn('getWasThisReviewHelpful', getWasThisReviewHelpful);
