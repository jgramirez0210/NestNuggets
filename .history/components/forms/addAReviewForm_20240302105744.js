...
import GetReviewById from '../StarRatingComponent';
...
function AddAReviewForm({ obj }) {
  ...
  useEffect(() => {
    getReviewRatings(user.uid).then((reviewRatings) => {
  ...
  return (
    <Form onSubmit={handleSubmit}>
      ...
      <FloatingLabel>
        {formInput.reviewId
          ? <GetReviewById firebaseKey={formInput.reviewId} reviews={[{ category: 'overall' }, { category: 'safety' }, { category: 'management' }]} />
          : null}
      </FloatingLabel>
      {/* RENTAL DURATION */}
