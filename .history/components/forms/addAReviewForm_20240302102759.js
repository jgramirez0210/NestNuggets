...
import GetReviewRating from '../StarRatingComponent';
...
function AddAReviewForm({ obj }) {
  ...
  return (
    <Form onSubmit={handleSubmit}>
      ...
      {/* RATING */}
      <FloatingLabel>
        {formInput && <GetReviewRating firebaseKey={formInput.reviewId} reviews={[{ category: 'overall' }, { category: 'safety' }, { category: 'management' }]} />}
      </FloatingLabel>
      {/* RENTAL DURATION */}
