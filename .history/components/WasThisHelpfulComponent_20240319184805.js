...
const WasThisReviewHelpful = ({ initialKey, userId }) => {
  ...
  const handleRating = async (ratingValue) => {
    ...
    const payload = {
      ...
      uid, // This will use the uid from the user object
    };
  ...
  useEffect(() => {
    const fetchKeyAndUid = async () => {
      // Replace with actual API call or other method of fetching initialFirebaseKey and uid
      const initialKey = await fetchInitialKey();
