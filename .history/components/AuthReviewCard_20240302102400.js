      ...
      <Card.Body>
        ...
        <p>
          ...
          {reviewRatingObj && reviewRatingObj.rating && (
            <>
              <span>Overall: {GetStars(reviewRatingObj.reviewRrating.overall)}</span><br />
              <span>Management: {GetStars(reviewRatingObj.rating.management)}</span><br />
              <span>Safety: {GetStars(reviewRatingObj.rating.safety)}</span>
            </>
          )}
        </p>
        {onDashboard && (
