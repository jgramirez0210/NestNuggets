...
const WasThisReviewHelpful = ({ initialKey, userId }) => {
  ...
  useEffect(() => {
    const fetchKey = async () => {
      // Replace with actual API call or other method of fetching initialFirebaseKey
      const key = await initialKey();
      setInitialFirebaseKey(key);
    };
