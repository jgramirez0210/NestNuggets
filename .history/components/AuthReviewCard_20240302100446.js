...
function AuthReviewCard({ firebaseKey, reviewObj, onDashboard, onUpdate }) {
      ...
      <Card.Body>
        ...
        <p>
          ...
          {reviewObj && reviewObj.reviewRating && (
            <>
              <span>Overall: {GetStars(reviewObj.reviewRating.overall)}</span><br />
              <span>Management: {GetStars(reviewObj.reviewRating.management)}</span><br />
              <span>Safety: {GetStars(reviewObj.reviewRating.safety)}</span>
            </>
          )}
        </p>
        {onDashboard && (
