...
function UnAuthReviewCard({ reviewObj }) {
  return (
      ...
      <Card.Body>
        ...
        {reviewObj && (
          <Link href={`/book/${reviewObj.firebaseKey}`} passHref>
            <Button variant="primary" className="m-2">  LOG IN TO VIEW MORE DETAILS</Button>
          </Link>
        )}
      </Card.Body>
    </Card>
...
export default UnAuthReviewCard;
