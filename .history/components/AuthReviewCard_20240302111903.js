...
import ReviewRatingCard from './reviewRatingsCard';
...
function AuthReviewCard({
  ...
  console.warn('reviewRatingObject', reviewRatingObj);
  return (
    <Card style={{ width: '30rem', margin: '10px' }}>
      ...
      <Card.Body>
        ...
        <p>
          {reviewRatingObj && <ReviewRatingCard reviewRatingObj={reviewRatingObj} />}
        </p>
        {onDashboard && (
          <>
