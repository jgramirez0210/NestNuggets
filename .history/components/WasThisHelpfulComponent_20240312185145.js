...
const WasThisReviewHelpful = ({ reviewObj, firebaseKey: initialFirebaseKey, reviews = [] }) => {
  ...
  const handleRating = async (ratingValue) => {
    ...
    const ratingsObject = await getWasThisReviewHelpful(reviewObj.firebaseKey);
...
WasThisReviewHelpful.propTypes = {
  ...
  reviewObj: PropTypes.shape({
    ...
    // Add other properties of reviewObj here
  }).isRequired,
};
