      ...
      .then((data) => {
        ...
        Object.values(data).forEach((firstLayer) => {
          Object.values(firstLayer).forEach((secondLayer) => {
            console.log('secondLayer.reviewId:', secondLayer.reviewId); // Add this line
            console.log('reviewObj.firebaseKey:', reviewObj.firebaseKey); // Add this line
            console.log('Type of secondLayer.reviewId:', typeof secondLayer.reviewId); // Add this line
            console.log('Type of reviewObj.firebaseKey:', typeof reviewObj.firebaseKey); // Add this line
            console.log('secondLayer has reviewId:', secondLayer.hasOwnProperty('reviewId')); // Add this line
