    ...
    <Card style={{ width: '40rem', margin: '10px' }}>
      ...
      <Card.Body>
        ...
        <p className="card-text bold">
          ...
          <input id="property" name="property" type="text" value={reviewObj && reviewObj.reviewProperty} />

          <label htmlFor="propertyManager">Property Manager: </label>
          <input id="propertyManager" name="propertyManager" type="text" value={reviewObj && reviewObj.reviewPropertyManager} />
        </p>
